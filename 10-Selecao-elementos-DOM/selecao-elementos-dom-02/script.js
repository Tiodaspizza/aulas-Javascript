...
// ! diferencas node list e htmlCollection 

 const gridSectionHTML = document.getElementsByClassName('grid-section') // ! HTMLCollection
const gridSectionNode = document.querySelectorAll('.grid-section')   // ! Nodelist
 
primeiroUL.classList.add('grid-section') // ! adicionou a classe grid-section ao primeiro ul da lista  apos isso a HTMLCollection foi atualizada e o nodelist nao
...
const gridSectionNode1 = document.querySelectorAll('.grid-section')

gridSectionNode1.forEach(function (item, index) {  // ** sintaxe basica de percorrer o array like com for each
 // console.log(item,index) 
})


const arrayGrid = Array.from(gridSectionHTML) // **  convertendo HTMLCollection em array

console.log(Array.isArray(arrayGrid)) // ** confirmar se e realmente um array
